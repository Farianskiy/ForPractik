...
{
    /// <summary>
    /// Логика взаимодействия для ProgramIndustrialPracticePage.xaml
    /// </summary>
    public partial class ProgramIndustrialPracticePage : System.Windows.Controls.Page
    {
        private List<OKEntry> okEntries;

        public ProgramIndustrialPracticePage()
        {
            InitializeComponent();
        }
        ...
        public void FillWordDocument(List<OKEntry> okEntries)
        {
            using (WordDocumentManager docManager = new WordDocumentManager())
            {
                ...
                string templatePath = "C:\\Users\\Farianskiy\\Desktop\\ForPractik\\ForPractik\\Resources\\ProgramIndustrialPractice.docx";
